...
RUN apk add --update --virtual runtime-deps postgresql-client nodejs libffi-dev readline imagemagick git file graphviz
...
ENV BUNDLE_PATH /ecommerce-gems
ENV BUNDLE_HOME /ecommerce-gems
...
ENV GEM_HOME /ecommerce-gems
ENV GEM_PATH /ecommerce-gems
...
ENV PATH /ecommerce-gems/bin:$PATH
